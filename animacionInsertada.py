...
class Player(pygame.sprite.Sprite):
    ...
    def update(self, keys, camera_dx, camera_dy):
        self.move(keys[pygame.K_LEFT], keys[pygame.K_RIGHT])
...
# Crear al jugador
jugador = Player('player', 200, HEIGHT - PLAYER_HEIGHT - 10, 3, PLAYER_SPEED)
...
while running:
    ...
    jugador.update_animation(tiempo_actual)
